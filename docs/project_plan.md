...
Use larger GPUs for main experiments:

- 6x A6000: 7B/14B, 16K/32K/64K, multi-step LoRA updates.

Do not rely on 4x T10 for main 7B+ long-context experiments unless memory-saving implementation is ready.
