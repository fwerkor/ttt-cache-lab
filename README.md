...
│   ├── E3：12 configs / 36 seeds；完成 3，运行 1
...
当前最准确的概括是：**投稿必需证据现为 51 个冻结配置、153 个 seed-run；已完成 9/51 个完整配置并验收 30/153 个 seed-run。W1-W3 已闭环，W4 只剩两个 seed；后续方法探索集中在 B，E2/E3 可继续并行运行。**
