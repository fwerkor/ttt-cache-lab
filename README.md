...
- 当前运行或待补齐验收条件：
  - E3 7B common_words seed 7：task probe 与 `run_metadata.json` 已生成，当前完成 368/512（约 71.9%），尚无 `.success` 与最终汇总产物
  - E3 1.5B needle_absent seed 7：task probe 与 `run_metadata.json` 已生成，当前完成 380/1,344（约 28.3%），尚无 `.success` 与最终汇总产物
