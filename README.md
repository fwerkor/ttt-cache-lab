...
- 当前运行或待补齐验收条件：
  - E3 7B common_words seed 7：task probe 与 `run_metadata.json` 已生成，当前完成 476/512（约 93.0%），尚无 `.success` 与最终汇总产物
  - E3 1.5B needle_absent seed 17：task probe 与 `run_metadata.json` 已生成，当前完成 233/1,344（约 17.3%），尚无 `.success` 与最终汇总产物
